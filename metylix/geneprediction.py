...
class FragGeneScanGUI(QWidget):
    ...
    def browse_script(self):
        script_path, _ = QFileDialog.getOpenFileName(self, "Select run_FragGeneScan.pl", filter="Perl Scripts (*.pl)")
        if script_path:
    ...
    def run_fraggenescan(self):
        ...
        # Bash command to run FragGeneScan in the conda environment
        bash_cmd = (
