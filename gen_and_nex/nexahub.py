...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setFontSize(transcriptomics_assembly_menu, 20)

        # Denovo submenu
        denovo_submenu = QMenu("Denovo", self)

        # Trinity submenu
        self.addSubMenuAction(denovo_submenu, "Trinity", "trinity.py")

        # RNA SPAdes submenu
        self.addSubMenuAction(denovo_submenu, "RNA SPAdes", "rnaspades.py")

        # Assembly Quality Assessment submenu
        self.addSubMenuAction(denovo_submenu, "Assembly Quality Assessment", "busco.py")

        # ORF Prediction submenu
        self.addSubMenuAction(denovo_submenu, "ORF Prediction", "transdecoder.py")

        # Count Table submenu
        self.addSubMenuAction(denovo_submenu, "Count Table", "rsem.py")
        ...
        self.setFontSize(mapping_menu, 20)

        # Bowtie2 submenu
        self.addSubMenuAction(mapping_menu, "Bowtie2", "bowtie.py")

        # STAR submenu
        self.addSubMenuAction(mapping_menu, "STAR", "star.py")

        # HiSat2 submenu
        self.addSubMenuAction(mapping_menu, "HiSat2", "hisat.py")

        # Count Table submenu
        self.addSubMenuAction(mapping_menu, "Count Table", "counts.py")
        ...
        # Transcriptomics Pipeline menu
        transcriptomics_pipeline_menu = menu_bar.addMenu("Transcriptomics Pipeline")
        self.setFontSize(transcriptomics_pipeline_menu, 20)

        # Denovo submenu
        self.addSubMenuAction(transcriptomics_pipeline_menu, "Denovo Pipeline", "denovo.py")

        # Reference submenu
        self.addSubMenuAction(transcriptomics_pipeline_menu, "Reference Pipeline", "reference.py")
        ...
        # Reference submenu
        self.addSubMenuAction(genomics_pipeline_menu, "Reference Pipeline", "genomics.py")

        # Create a QLabel for the message
        message_label = QLabel(self)
        message_label.setText("Developed by Anitha Ravichandran And Akhansha\nCorresponding author N Saranya\nCPMB & B, TNAU.")
